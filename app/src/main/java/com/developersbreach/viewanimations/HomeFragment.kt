...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.simple_transition_text_view).setOnClickListener {
            findNavController().navigate(R.id.homeToSimpleTransitionsFragment)
        }

        view.findViewById<TextView>(R.id.coordinated_motion_text_view).setOnClickListener {
